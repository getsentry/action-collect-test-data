...
def json_compact(json_doc: str) -> str:
    """remove insignificant whitespace from a json document"""
    import json

    return json.dumps(json.loads(json_doc), indent=None, separators=(",", ":"))
...
GITHUB_MATRIX={json_compact(env["GITHUB_MATRIX"])}
